...
实验标识：v_uni
路径：config/train_config_v_uni.py
"""
...
class TrainConfig:
    ...
    # ========== 实验标识 ==========
    EXPERIMENT_NAME = 'v_uni'  # 垂直单向
    DESCRIPTION = 'Vertical Layout + Unidirectional Routing'
    ...
    CHECKPOINT_DIR = './data/checkpoints_v_uni'  # 检查点目录
    LOG_DIR = './data/logs_v_uni'  # 日志目录
    TENSORBOARD_DIR = './runs_v_uni'  # TensorBoard目录
